...
function RentabilityComparisonCalculator() {
    ...
    return (
        <div className="p-8">
            ...
            <p className="text-gray-600 mb-6">Compare os rendimentos entre investimentos em LCI/LCAs e CDB</p>
                ...
                {result && (
                    <div className="mt-6 space-y-4">
                        <div className="p-4 bg-green-50 rounded-lg border-2 border-green-200">
                            <h3 className="text-lg font-semibold text-green-800 mb-3">Resultados LCI/LCAs:</h3>
                            <div className="space-y-1">
                                <p className="text-gray-700">
                                    <span className="font-medium">Valor Total:</span> R${result.lci.total}
                                </p>
                                <p className="text-gray-700">
                                    <span className="font-medium">Lucro:</span> R${result.lci.profit}
                                </p>
                            </div>
                        </div>

                        <div className="p-4 bg-purple-50 rounded-lg border-2 border-purple-200">
                            <h3 className="text-lg font-semibold text-purple-800 mb-3">Resultados CDB:</h3>
                            <div className="space-y-1">
                                <p className="text-gray-700">
                                    <span className="font-medium">Valor Total:</span> R${result.cdb.total}
                                </p>
                                <p className="text-gray-700">
                                    <span className="font-medium">Lucro:</span> R${result.cdb.profit}
                                </p>
                            </div>
                        </div>

                        <div className="p-4 bg-blue-50 rounded-lg border-2 border-blue-300">
                            <h3 className="text-lg font-semibold text-blue-800 mb-3">Comparativo:</h3>
                            <div className="space-y-1">
                                <p className="text-gray-700">
                                    <span className="font-medium">Diferença:</span> R${result.difference}
                                </p>
                                <p className="text-lg font-bold text-blue-900 mt-2">
                                    Melhor Opção: {result.betterOption}
                                </p>
                            </div>
                        </div>
                    </div>
